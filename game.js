...
var Game = function (cols, rows, number_of_bombs, theme, usetwemoji) {
  ...
  console.log(usetwemoji);

  //this.emojiset = set
  this.theme = theme;
  this.emojiset = tailimg;
...
Game.prototype.bindEvents = function () {
  ...
  Array.prototype.forEach.call(cells, function (target) {
    ...
    target.addEventListener('contextmenu', function (evt) {   //mouse rightbutton
      var emoji
      evt.preventDefault()
      if (!target.isMasked) { return }
      if (target.isFlagged) {
...
Game.prototype.resetMetadata = function () {
  ...
  document.querySelector('.top').classList.remove('won', 'lost')
  ...
  //document.querySelector('.result-emoji').src = "";
  //document.querySelector('.default-emoji').src = "img/smile.png";
  //document.querySelector('.js-settings').innerHTML = this.usetwemoji ? twemoji.parse('🔧') : '🔧'

  document.querySelector('.js-new-game').src = "img/smile.png";
}
...
Game.prototype.showMessage = function () {
  ...
  var label = winner ? "won! <br>"+seconds+"s" : "gameover <br>"+seconds+"s";
  //var emoji = winner ? '1' : '2'
  //var emoji = winner ? '😎' : '😵'
  this.updateFeedback(winner ? "Yay, you won!" : "Boom! you lost.")
  document.querySelector('.top').classList.add(this.result)
  document.getElementById('timer').textContent = seconds

  cusAlert(label);
  //document.getElementById('result').innerHTML = this.usetwemoji ? twemoji.parse(emoji) : emoji
  //document.getElementById('result').src = winner ? "img/clear.png" : "img/deed.png";

  document.querySelector('.js-new-game').src = winner ? "img/clear.png" : "img/dead.png";
